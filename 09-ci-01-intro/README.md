...
Создайте две задачи в Backlog доске, например "Bug on Frontend", "Integrate YandexPay"
Переместите все задачи на доску Sprint, в колонку Бэклог спринта.
Переместите одну из задач в колонку работа и добавьте там комментарий по желанию, например, "Bug on Frontend" -> "Баг будет устранён путём обновления библиотеки в микрофронтенде".
